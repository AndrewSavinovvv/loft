    ...
    <div class="container">
      <div class="footer__grid">
        <div class="footer__logo">
          <a href="#!">
            <img src="@/assets/img/logo.svg" alt="LoftHouse">
          </a>
        </div>
        ...
        <div class="footer__address">
          ...
          <ul class="footer__socials">
            <li><a href="#!"><img src="@/assets/img/socials/youtube.svg" alt=""></a></li>
            <li><a href="#!"><img src="@/assets/img/socials/vk.svg" alt=""></a></li>
            <li><a href="#!"><img src="@/assets/img/socials/facebook.svg" alt=""></a></li>
            <li><a href="#!"><img src="@/assets/img/socials/instagram.svg" alt=""></a></li>
          </ul>
        </div>
      </div>
    </div>
